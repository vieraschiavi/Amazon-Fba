...
<title>Propuesta de inversion — MV FBA IA</title>
<style>
 ...
 <div class="hero">
  <h1>MV FBA <span class="g">IA</span> — Propuesta de inversion</h1>
 ...
 <div class="pie">Generado por MV FBA IA — mismos numeros y mismo motor que el panel de control.</div>
</div></body></html>"""
