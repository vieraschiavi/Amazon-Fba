...
if not defined PYTHON ( echo  [ERROR] Python no encontrado. Si instalaste MV FBA IA, reinstalalo: & echo  el runtime incluido ^(runtime\python.exe^) esta incompleto o fue borrado. & pause & exit /b 1 )
